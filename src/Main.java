...
//TO DO
/*
make entities show up when they are not being controlled by player (where did anya go, e.g. ...)
...
public class Main extends PApplet{
    ...
    public void setup() {
        ...
        player.display();
        Entity enemy = new Entity(NUM_ROWS/2 + 1, NUM_COLS/2, 3, 3, 1, enemyImage, false);
        enemy.display();
    }
